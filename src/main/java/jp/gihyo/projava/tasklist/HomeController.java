...
//    private List<TaskItem> taskItems = new ArrayList<>();
    ...
    String searchMonth(Model model, @RequestParam("month") String month,
        ...
        List<TaskItem> taskItems = this.dao.searchMonth(month,complete);
        model.addAttribute("taskList", taskItems);

        return "home";
    }
//    @GetMapping("/search_complete")
//    String complete(Model model, @RequestParam("complete") String complete){
//        List<TaskItem> taskItems = this.dao.search_complete(complete);
//        model.addAttribute("taskList", taskItems);
//        return "home";
//    }
}
